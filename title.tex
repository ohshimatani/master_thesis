...
% ------main
\groebner{}基底とは，1965年にBruno Buchbergerによって発表された多変数多項式の割り算（単項簡約）を一意に行うことのできるイデアルの生成系である．\groebner{}基底を計算することによって連立代数方程式の厳密解を求めることができるため，計算機代数分野において重要な研究対象となっている．他にも，代数統計学・代数幾何学・組合せ論などの他分野への応用も盛んに行われている．
